    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(
        ...
        builder: (context, _) {
          ...
          final contextSummary = state.chatThread?.contextSummary ?? _contextSummaryFallback(state);
          ...
          return Column(
            children: [
              ...
              if (state.isLoadingChat || state.isSendingChat) const LinearProgressIndicator(minHeight: 2),
                  ...
                  child: _RecipeRail(
                    ...
                    onOpen: (card) {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => RecipeDetailView(meal: card.toPlannedMeal())),
                      );
                    },
                    onApply: (card) => unawaited(state.applyPlannedMeal(card.toPlannedMeal())),
                  ),
                ),
              Expanded(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: _MessageBubble(
                        ...
                        onApplyRecipe: (card) => unawaited(state.applyPlannedMeal(card.toPlannedMeal())),
                      ),
                    );
                  },
                ),
      ...
      builder: (sheetContext) {
        return SafeArea(
          child: ListView(
            ...
            children: [
              Text('Hızlı aksiyonlar', style: Theme.of(sheetContext).textTheme.titleLarge),
              ...
              _ActionTile(
                ...
                onTap: () {
                  Navigator.of(sheetContext).pop();
                  Navigator.of(context).push(MaterialPageRoute(builder: (_) => const FoodSearchView()));
                },
              ),
...
class _ContextBand extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ratio = calorieTarget == 0 ? 0.0 : (consumedCalories / calorieTarget).clamp(0.0, 1.0);
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text('Nuri bağlamı', style: Theme.of(context).textTheme.titleMedium),
              ),
          ...
          Row(
            children: [
              Expanded(child: Text('$consumedCalories / $calorieTarget kcal', style: Theme.of(context).textTheme.labelLarge)),
              Text('Kalan $remainingCalories kcal', style: Theme.of(context).textTheme.labelLarge),
            ],
          ),
        ],
      ),
            ...
            children: [
              Row(
                children: [
                  ...
                  _MiniPill(text: card.mealType == MealType.dinner ? 'Akşam' : card.mealType.title),
                ],
              ),
              const SizedBox(height: 10),
              Text(card.description, maxLines: 3, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodyMedium),
              const SizedBox(height: 12),
              Wrap(
                spacing: 8,
                runSpacing: 8,
          ...
          children: [
            ...
            if (message.contextSummary != null) ...[
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.labelSmall?.copyWith(color: NutriColors.muted),
              ),
            ],
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(card.subtitle, style: Theme.of(context).textTheme.bodySmall),
            const SizedBox(height: 10),
            Text(card.description, maxLines: 2, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodySmall),
            const Spacer(),
            Row(
              children: [
                Expanded(
